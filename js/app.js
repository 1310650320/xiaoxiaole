...
var DDP = {
    ...
    countdown: function() {
        var self = this;
        this.timeLeft--;
		$("#progress-text").html(this.getFormattedTime(this.timeLeft));
    ...
    updateScore: function(points, tile) {
		...
		wx_game_fraction=this.score;
        this.$score.innerHTML = "分数："+this.score;
    },
